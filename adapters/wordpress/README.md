...
This is the source under `adapters/wordpress/` of the [xrechnung-kit](https://github.com/vinelabs-de/xrechnung-kit) monorepo. It is published to Packagist as a standalone WordPress plugin via the auto-publish workflow.
...
If you have a near-term WordPress / WooCommerce use case for XRechnung, [open an issue](https://github.com/vinelabs-de/xrechnung-kit/issues) describing the integration shape you need.
